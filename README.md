...
Version 2.1.0 / HTTPD 2.4.x

This package contains custom CSS that can be used with Apache HTTP Server as 
the `IndexStyleSheet` for server-generated directory listings.
...
it is not relative to the server's document root. See the [mod_alias][2] module 
